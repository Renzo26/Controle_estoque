...
import { Home, Package, ArrowDownToLine, ArrowUpFromLine, BarChart3, History, Settings, Plus, Menu, Plane, Store } from "lucide-react";
...
const desktopNav = [
  ...
  { to: "/catalogo", label: "Catálogo (clientes)", icon: Store },
] as const;
